...
public class ImpulseScene
{
	...
	// don't use ImpulseMath's static gravity vector
	...
	/*
	 * new setter - without it, it's impossible to adjust gravity
	 * if it isn't called, the default value (0.50f) is kept
	 */
...
//		b->angularVelocity += b->torque * b->iI * (dt / 2.0f);
		...
		b.velocity.addsi( gravity, dts ); // adjusted to support setGravity
